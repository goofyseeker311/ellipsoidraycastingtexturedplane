...
flatspheresx = 10; flatspheresy = 10; flatspheres=flatspheresx*flatspheresy; nspheres+=flatspheres; for fy=1:flatspheresy; for fx=1:flatspheresx;
scenespheres = [scenespheres; [[fx*20+mod(fy,2)*10 fy*10-50 -50] 10 [1 1 10] randi(255,1,3)/255 randi(wimagescount+1,1,1)-1]]; endfor; endfor;
